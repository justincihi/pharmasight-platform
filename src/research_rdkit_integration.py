...
class ResearchRDKitIntegration:
    ...
    def __init__(self):
        ...
        self.analog_discovery_log = "/home/ubuntu/pharmasight-latest/MASTER_ANALOG_DISCOVERIES.json"
        self.research_findings_path = "/home/ubuntu/pharmasight-latest/enhanced_research_findings.json"
