...
import { Home, LayoutDashboard, BarChart3, TestTube2, Layers, LogOut, Calendar, Package, ExternalLink, GitCompare, FileText, FlaskConical } from "lucide-react";
...
export function Navigation() {
  ...
  const navItems = [
    ...
    { path: "/research-history", label: "Research", icon: FlaskConical, adminOnly: true },
  ];
