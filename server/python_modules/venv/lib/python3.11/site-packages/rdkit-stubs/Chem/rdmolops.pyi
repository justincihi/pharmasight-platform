...
def CombineMols(mol1: Mol, mol2: Mol, offset: Point3D = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CombineMols(RDKit::ROMol,RDKit::ROMol [,RDGeom::Point3D=<rdkit.Geometry.rdGeometry.Point3D object at 0x7f0d787400c0>])
    """
...
def CopyMolSubset(mol: Mol, atomIndices: typing.Any, bondIndices: typing.Any, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,boost::python::api::object [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x7f0d7889b3e0>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, atomIndices: typing.Any, bondIndices: typing.Any, subsetInfo: SubsetInfo, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,boost::python::api::object,RDKit::SubsetInfo {lvalue} [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x7f0d7889b450>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, path: typing.Any, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x7f0d7889b4c0>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, path: typing.Any, subsetInfo: SubsetInfo, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,RDKit::SubsetInfo {lvalue} [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x7f0d7889b5a0>])
    """
...
def molzip(a: Mol, b: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(RDKit::ROMol,RDKit::ROMol [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x7f0d787d75e0>])
    """
@typing.overload
def molzip(a: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(RDKit::ROMol [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x7f0d787d7690>])
    """
@typing.overload
def molzip(row: dict, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(boost::python::dict [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x7f0d787d78a0>])
    """
def molzipFragments(mols: typing.Any, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzipFragments(boost::python::api::object {lvalue} [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x7f0d787d77f0>])
    """
