...
import rdkit.Chem
import typing
__all__: list[str] = ['ALL', 'ANNOTATIONS', 'ATOMLABELS', 'BONDS', 'CircleAndLine', 'ContourAndDrawGaussians', 'ContourAndDrawGrid', 'ContourParams', 'DrawElement', 'DrawMoleculeACS1996', 'HIGHLIGHTS', 'IntStringMap', 'Lasso', 'MeanBondLength', 'MolDraw2D', 'MolDraw2DCairo', 'MolDraw2DSVG', 'MolDrawOptions', 'MolToACS1996SVG', 'MolToSVG', 'MultiColourHighlightStyle', 'NONE', 'POSTSHAPES', 'PRESHAPES', 'PrepareAndDrawMolecule', 'PrepareMolForDrawing', 'RADICALS', 'SetACS1996Mode', 'SetDarkMode', 'SetMonochromeMode', 'UpdateDrawerParamsFromJSON', 'UpdateMolDrawOptionsFromJSON', 'map_indexing_suite_IntStringMap_entry']
class ContourParams(Boost.Python.instance):
    ...
    def fillThreshold(*args, **kwargs):
        ...
    @property
    def fillThresholdIsFraction(*args, **kwargs):
        """
    ...
    def setScale(*args, **kwargs):
        ...
    @property
    def useFillThreshold(*args, **kwargs):
        """
...
class MolDraw2DCairo(MolDraw2D):
    ...
    """
    __instance_size__: typing.ClassVar[int] = 984
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
...
class MolDraw2DSVG(MolDraw2D):
    ...
    SVG molecule drawer
    """
    __instance_size__: typing.ClassVar[int] = 1368
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
...
class MolDrawOptions(Boost.Python.instance):
    ...
    Drawing options
    """
    __instance_size__: typing.ClassVar[int] = 720
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
    @staticmethod
    ...
    def getAtomPalette(self) -> dict:
        """
            ...
            C++ signature :
                boost::python::dict getAtomPalette(RDKit::MolDrawOptions)
        """
    ...
    def bondNoteColour(*args, **kwargs):
        ...
    @property
    def bracketsAroundAtomLists(*args, **kwargs):
        """
    ...
    def drawMolsSameScale(*args, **kwargs):
        ...
    @property
    def drawingExtentsInclude(*args, **kwargs):
        """
    ...
    def queryColour(*args, **kwargs):
        ...
    @property
    def reagentPadding(*args, **kwargs):
        """
    ...
    def scalingFactor(*args, **kwargs):
        ...
    @property
    def showAllCIPCodes(*args, **kwargs):
        """
    ...
    def splitBonds(*args, **kwargs):
        ...
    @property
    def standardColoursForHighlightedAtoms(*args, **kwargs):
        """
...
def ContourAndDrawGaussians(drawer: MolDraw2D, locs: typing.Any, heights: typing.Any, widths: typing.Any, nContours: int = 10, levels: typing.Any = None, params: ContourParams = ..., mol: typing.Any = None) -> None:
    """
        ...
        */
        ...
        C++ signature :
            void ContourAndDrawGaussians(RDKit::MolDraw2D {lvalue},boost::python::api::object,boost::python::api::object,boost::python::api::object [,unsigned int=10 [,boost::python::api::object=None [,RDKit::MolDraw2DUtils::ContourParams=<rdkit.Chem.Draw.rdMolDraw2D.ContourParams object at 0x7f786f8a22f0> [,boost::python::api::object=None]]]])
    """
def ContourAndDrawGrid(drawer: MolDraw2D, data: typing.Any, xcoords: typing.Any, ycoords: typing.Any, nContours: int = 10, levels: typing.Any = None, params: ContourParams = ..., mol: typing.Any = None) -> None:
    """
        ...
        */
        ...
        C++ signature :
            void ContourAndDrawGrid(RDKit::MolDraw2D {lvalue},boost::python::api::object {lvalue},boost::python::api::object {lvalue},boost::python::api::object {lvalue} [,unsigned int=10 [,boost::python::api::object {lvalue}=None [,RDKit::MolDraw2DUtils::ContourParams=<rdkit.Chem.Draw.rdMolDraw2D.ContourParams object at 0x7f786f8a23e0> [,boost::python::api::object=None]]]])
    """
...
def MolToSVG(mol: Mol, width: int = 300, height: int = 300, highlightAtoms: typing.Any = None, kekulize: bool = True, lineWidthMult: int = 1, includeAtomCircles: bool = True, confId: int = -1) -> str:
    """
        ...
        C++ signature :
            std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > MolToSVG(RDKit::ROMol [,unsigned int=300 [,unsigned int=300 [,boost::python::api::object=None [,bool=True [,unsigned int=1 [,bool=True [,int=-1]]]]]]])
    """
