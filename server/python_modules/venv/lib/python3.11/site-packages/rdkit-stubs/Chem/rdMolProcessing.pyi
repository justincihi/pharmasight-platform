...
def GetFingerprintsForMolsInFile(filename: str, generator: typing.Any = None, options: SupplierOptions = ...) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GetFingerprintsForMolsInFile(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > [,boost::python::api::object=None [,RDKit::GeneralMolSupplier::SupplierOptions=<rdkit.Chem.rdMolProcessing.SupplierOptions object at 0x7f429a30dd80>]])
    """
@typing.overload
def GetFingerprintsForMolsInFile(filename: str, generator: typing.Any = None, options: SupplierOptions = ...) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GetFingerprintsForMolsInFile(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > [,boost::python::api::object=None [,RDKit::GeneralMolSupplier::SupplierOptions=<rdkit.Chem.rdMolProcessing.SupplierOptions object at 0x7f429a30de50>]])
    """
